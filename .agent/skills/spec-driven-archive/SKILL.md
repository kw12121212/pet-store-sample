...
1. **Select the change** — run `node /home/code/Code/pet-store-sample/.agent/skills/spec-driven-archive/scripts/spec-driven.js modify` to list active changes. Ask which change to archive. If already specified, use it.

2. **Check for incomplete tasks** — run:
   ```
   node /home/code/Code/pet-store-sample/.agent/skills/spec-driven-archive/scripts/spec-driven.js apply <name>
   ```
...
3. **Archive the change** — run:
   ```
   node /home/code/Code/pet-store-sample/.agent/skills/spec-driven-archive/scripts/spec-driven.js archive <name>
   ```
