...
1. **Select the change** — run `node .agent/skills/spec-driven-review/scripts/spec-driven.js modify` to list active changes. Ask which change to review. If already specified, use it.

2. **Confirm readiness** — run:
   ```
   node .agent/skills/spec-driven-review/scripts/spec-driven.js apply <name>
   ```
