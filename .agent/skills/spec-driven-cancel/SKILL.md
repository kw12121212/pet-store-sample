...
1. **Select the change** — run `node /home/code/Code/pet-store-sample/.agent/skills/spec-driven-cancel/scripts/modify.js` to list active changes. Ask which change to cancel. If already specified, use it.
...
3. **Cancel the change** — run:
   ```
   node /home/code/Code/pet-store-sample/.agent/skills/spec-driven-cancel/scripts/cancel.js <name>
   ```
